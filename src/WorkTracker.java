...
public class WorkTracker {
    ...
    private static void showAboutDeveloper() {
        ...
        developerInfo.setText("Developer Name: Zaid Rakhange\n\n"
                + "A passionate developer trying to create \n good apps !.\n\n"
                + "GitHub: https://github.com/zaid-commits\n\n"
                + "LinkedIn: https://linkedin.com/in/zaidrakhange");
        ...
        githubButton.addActionListener(e -> openLink("https://github.com/zaid-commits"));
        linkPanel.add(githubButton);

        JButton linkedInButton = new JButton("LinkedIn");
        linkedInButton.addActionListener(e -> openLink("https://linkedin.com/in/zaidrakhange"));
